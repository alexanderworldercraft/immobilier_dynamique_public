...
$sql = "SELECT agent.prenom, agent.nom, maison.id_agent FROM maison 
INNER JOIN agent ON maison.id_agent = agent.id_agent 
WHERE maison.id_maison = $id_maison GROUP BY maison.id_maison;";
